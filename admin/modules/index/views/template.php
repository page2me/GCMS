<?php
/*
 * @filesource index/views/template.php
...
class View extends \Gcms\Adminview
{
   ...
   * @return string
   */
  public function render($dir, $config, $themes)
  {
    ...
    // หน้าที่เลือก
    $page = self::$request->get('page', 1)->toInt();
    $page = ($page < 1) ? 1 : $page;
    ...
    $div->appendChild('<div class="splitpage">'.self::$request->getUri()->pagination($totalpage, $page).'</div>');
    return $div->render();
  }

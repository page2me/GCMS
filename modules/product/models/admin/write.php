<?php
/*
 * @filesource product/models/admin/write.php
...
class Model extends \Kotchasan\Model
{
   ...
   * @param boolean $new_id true คืนค่า ID ของบทความรายการใหม่ (สำหรับการบันทึก), false คืนค่า ID 0 หากเป็นรายการใหม่
  ...
  public static function getPrice($price, $currency_unit)
  {
    ...
    if (!is_array($values)) {
      $values = array($currency_unit => (double)$price);
    }
    return $values;
  }

<?php
/*
 * @filesource documentation/controllers/admin/settings.php
...
class Controller extends \Gcms\Controller
{
  ...
  {
    // ข้อความ title bar
    $this->title = '{LNG_Module settings} {LNG_Documentation}';
    // เลือกเมนู
    $this->menu = 'modules';
    // อ่านข้อมูลโมดูล
    ...
    if ($index && Gcms::canConfig($login, $index, 'can_config')) {
      ...
      // แสดงฟอร์ม
      $section->appendChild(createClass('Documentation\Admin\Settings\View')->render($index));

<?php
/*
 * @filesource document/controllers/admin/settings.php
...
class Controller extends \Gcms\Controller
{
  ...
  {
    // ข้อความ title bar
    $this->title = '{LNG_Module settings} {LNG_Document}';
    // เลือกเมนู
    $this->menu = 'modules';
    // อ่านข้อมูลโมดูล
    $index = \Index\Adminmodule\Model::get('document', $request->get('mid')->toInt());
    // login

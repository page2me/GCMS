<?php
/*
 * @filesource portfolio/controllers/admin/settings.php
...
class Controller extends \Gcms\Controller
{
  ...
  {
    // ข้อความ title bar
    $this->title = '{LNG_Module settings} {LNG_Portfolio}';
    // เลือกเมนู
    $this->menu = 'modules';
    // อ่านข้อมูลโมดูล
    ...
    if ($index && Gcms::canConfig($login, $index, 'can_config')) {
      ...
      // แสดงฟอร์ม
      $section->appendChild(createClass('Portfolio\Admin\Settings\View')->render($index));

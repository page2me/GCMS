...
การอัปเกรดจาก GCMS 11.2.0 ขึ้นไปเป็น GCMS 12.0.0 อัปโหลดไฟล์ทั้งหมดจากที่ดาวน์โหลดไป ยกเว้นไดเร็คทอรี่ install/ ไปแทนที่ไฟล์เดิมได้เลยโดยไม่ต้องเรียกตัวติดตั้ง
```